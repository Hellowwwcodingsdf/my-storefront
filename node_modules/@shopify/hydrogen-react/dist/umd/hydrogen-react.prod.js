...
`,ae="2025-01",vr="mock.shop",Ue=e=>e.includes(vr);function Pr({storeDomain:e,privateStorefrontToken:t,publicStorefrontToken:r,storefrontApiVersion:n=ae,contentType:a}){if(!e)throw new Error(ke+"`storeDomain` is required when creating a new Storefront client in production.");n!==ae&&Or(`The Storefront API version that you're using is different than the version this build of Hydrogen React is targeting.
