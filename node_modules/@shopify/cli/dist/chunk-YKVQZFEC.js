...
async function launchCLI(options) {
  let { errorHandler } = await import("./error-handler-AWP3RCBG.js"), { isDevelopment } = await import("./local-RBT53U3L.js"), oclif = await import("./lib-IZAG57CE.js"), { ShopifyConfig } = await import("./custom-oclif-loader-TUNXMYGU.js");
...
async function exitIfOldNodeVersion(versions = process.versions) {
  ...
  if (nodeMajorVersion < 18) {
    let { renderError } = await import("./ui-5MADIMGC.js");
    renderError({
...
async function addInitToArgvWhenRunningCreateCLI(options, argv = process.argv) {
  let { findUpAndReadPackageJson } = await import("./node-package-manager-BZHJZTGV.js"), { moduleDirectory } = await import("./path-2K5HIMHZ.js"), name = (await findUpAndReadPackageJson(moduleDirectory(options.moduleURL))).content.name.replace("@shopify/create-", "");
...
//# sourceMappingURL=chunk-YKVQZFEC.js.map
